...
All tests were conducted on an Ubuntu 20.04.5 server using 35 cores with dual Intel Xeon CPU E5-2640 v4 and 94G ram.  
...
It takes about 30 minutes to train a model from our server with 35 cores.
# References
